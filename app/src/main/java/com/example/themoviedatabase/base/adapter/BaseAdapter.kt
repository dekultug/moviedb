package com.example.themoviedatabase.base.adapter
...
import com.example.themoviedatabase.common.getAppColor
import com.example.themoviedatabase.common.getAppDrawable
import com.example.themoviedatabase.databinding.BaseEmptyDefaultItemBinding
import com.example.themoviedatabase.databinding.BaseLoadMoreDefaultItemBinding
...
abstract class BaseAdapter : RecyclerView.Adapter<BaseVH<Any>>() {
    ...
    @Deprecated("không override func này, nếu muốn thay đổi layout loadmore thì override func #setupLoadMoreState() ")
    ...
    @Deprecated("không override func này, nếu muốn thay đổi layout emmty thì override func #setupEmptyState() ")
    open fun getLayoutEmpty() = R.layout.base_empty_default_item
    ...
    class Empty(
        val message: String = STRING_DEFAULT,
        val messageColor: Int = getAppColor(R.color.black),
        val iconEmpty: Drawable? = getAppDrawable(R.drawable.img_default),
        val overrideLayoutRes: Int? = null,
    )
}
